...
class Upload(Command):
    ...
    def setup_arg_parser(self, parser):
        ...
        parser.add_argument('-r', '--programmer', metavar='PROGRAMMER',
                            help='Programmer to upload with.\nUpload using serial if not specified')
    ...
    def upload_programmer(self, board, protocol):
      subprocess.call([
          self.e['avrdude'],
          '-C', self.e['avrdude.conf'],
          '-p', board['build']['mcu'],
    ...
    def run(self, args):
      ...
      if programmer is None:
        ...
        self.upload_serial(board, protocol, port)

      else:
        self.upload_programmer(board, programmer)
